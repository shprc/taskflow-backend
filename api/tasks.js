...
module.exports = async (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    const { error } = await supabase.from('tf_tasks').upsert({
      ...
      list_name: t.listName || (t.category === 'people' ? 'Team' : t.category === 'projects' ? 'General' : 'Personal Actions'),
      list: t.listName || (t.category === 'people' ? 'Team' : t.category === 'projects' ? 'General' : 'Personal Actions'),
      tags: t.tags || [],
